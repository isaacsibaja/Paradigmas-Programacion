<?php
	...
	class ControladoraProductoLote {
		
		function ControladoraProductoLote(){
		}		
		...
		function insertar(){
			...
			$cantidad = str_replace(",", ".", $_POST['cantidad']);// ( se indica el carácter que se quiere remplazar  ,  el nuevo carácter, el string que se desea modificar  )
		...
		$accion=$_POST['accion'];
		$control = new ControladoraProductoLote;		
